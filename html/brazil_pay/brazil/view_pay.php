                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>View Tokens requested by You</b></h4>
                            <hr/>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0"
                                ...
                                <thead>
                                 ...
                                 <tbody style="color: #333">
                                   <?php                      
                                      try {
                                          $stmt = $pdo->prepare('SELECT * FROM `pay_request` WHERE `from_user`="'.$pdo_auth['tx_address'].'" ORDER BY date DESC ');
                                      ...
                                      foreach ($user as $key => $value) {
                                        ...
                                        echo ' <tr style="color:#333">
                                               ...
                                               <td>'.$value['date'].'</td>
                                               <td>'.$status.'</td>
                                               <td><a href="delete_pay_now.php?id='.$value['id'].'" onclick="return confirm(\'Are your Sure want to delete this, this entries will never be rolled back once deleted\')" class="btn btn-danger btn-sm">Delete</a></td>
                                             </tr>';
                                              $i++;
                                      }
                                     ?>                   
