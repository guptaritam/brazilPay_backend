...
<?php require 'includes/header_end.php';
    $lata = get_data_id_data("pay_request", "id", $_REQUEST['id']);
   //print_r($lata);
    
    $to_username  = tx_to_username($lata['from_user']);
    ///echo "tybhjkgjh".$to_username;
?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Pay Requested Tokens</h4>
            ...
            <div class="row">               
                ...
                <div class="col-xl-6 col-xs-12">
                    <div class="card-box items">
                       <div class="century" style="font-size: 24px;color: #333">Pay Brazil Pay Tokens</div>
                          ...
                          <div style="padding: 10px;"></div>
                           ...
                           <form method="POST" action="pay_it_handle.php">
                               
                              <div class="form-group" >
                                <label>Enter Username </label>
                                <input type="text" class="form-control" name="username" id="username" readonly value="<?php echo $to_username['username'];  ?>"  placeholder="Enter Username of User ">
                             </div>
                              ...
                              <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="to_address" id="to_address" readonly value="<?php echo $lata['from_user'];  ?>"  placeholder="Enter Brazil PayX Token Address address">
                             </div>
                            
                             <div class="form-group" >
                                <label>Your Brazil Pay Token Address</label>
                                <input type="text" class="form-control" name="tx_addresss"  readonly="" value="<?php echo $lata['to_user']; ?>"  placeholder="Your Brazil Pay Token Address">
                             </div>
                             ...
                             <div class="form-group" >
                                ...
                                <input type="number" min="0" class="form-control"  step=".0001" name="token_no" max="<?php echo $pdo_auth['balance']; ?>" value="<?php echo $lata['amount'];  ?>" readonly  placeholder="Enter No. of Brazil Pay Token to Send">
                             </div>
