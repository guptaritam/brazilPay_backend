                                      ...
                                      foreach ($user as $key => $value) {
                                        ...
                                        echo ' <tr>
                                                ...
                                                <td>'.$value['user_name'].'<br/>
                                                    <span style="font-size:12px;color:#888">'.$value['remark'].'</span>
                                                </td>
                                                <td><b>To : </b>'.$to['username'].'<br/><b>From : </b>'.$from['username'].'<br/> <label class="label label-success">'.$value['tx_hash'].'</label></td>
