                                ...
                                <thead>
                                    <tr>
                                      <th style="color:#000;opacity: .4">S.No</th>
                                       <th style="color:#000;opacity: .4">Data</th>
                                      <th style="color:#000;opacity: .4">Amount </th>
                                      <th style="color:#000;opacity: .4">Transfer To </th>
                                   ...
                                   <?php                      
                                      ...
                                      foreach ($user as $key => $value) {
                                        ...
                                        echo ' <tr style="color:#333">
                                               <td>'.$i.'</td>
                                               <td>'.$value['user_name'].'<br/><b>Withdraw Address : </b><pre>'.$value['withdraw_wallet_address'].'</pre></td>
                                               <td><b style="font-size:12px;text-transform:capitalize">'.$value['amount'].' SXT</b></td>
                                               <td><b style="font-size:12px;text-transform:capitalize">'.$value['transfer_to'].' </b></td>
                                               <td>'.$value['date'].'</td>
                                               <td>'.$status.'</td>
                                             </tr>';
                                              $i++;
